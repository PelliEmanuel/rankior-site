...
import { Shield, Target, Zap, Award, Users2, Building2 } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          ...
          <section className="mb-32">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {values.map((value, i) => (
                <ScrollReveal key={i} delay={i * 0.1}>
                  <div className="p-8 rounded-3xl bg-white/[0.02] border border-white/10 hover:bg-white/[0.05] transition-colors h-full">
